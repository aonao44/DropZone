      ...
      <main className="py-8 sm:py-12 lg:py-16">
        <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8 sm:mb-10">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-3 sm:mb-4">プロジェクト一覧</h1>
          ...
          {projects.length === 0 ? (
            <div className="bg-white border-2 border-dashed border-gray-300 rounded-2xl sm:rounded-3xl p-8 sm:p-12 lg:p-16 text-center">
              <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 mx-auto bg-gray-50 rounded-full flex items-center justify-center mb-6 sm:mb-8">
                <Inbox className="h-10 w-10 sm:h-12 sm:w-12 lg:h-14 lg:w-14 text-gray-400" />
              </div>
              ...
              <Button
                onClick={() => router.push("/dashboard/new")}
                className="bg-blue-500 text-white font-semibold px-6 py-3 sm:px-8 sm:py-4 lg:px-10 lg:py-5 rounded-xl shadow-md hover:bg-blue-600 hover:shadow-lg transition-all duration-200 text-base sm:text-lg"
              >
            ...
            <div className="grid gap-4 sm:gap-6 lg:gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              {projects.map((project) => (
                <Card
                  key={project.id}
                  className="bg-white border-2 border-gray-300 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-xl hover:border-gray-400 transition-all duration-200"
                >
                  <CardHeader className="pb-3 sm:pb-4 space-y-2 sm:space-y-3 p-5 sm:p-6 lg:p-8">
                    <CardTitle className="text-xl sm:text-2xl font-semibold text-gray-900 line-clamp-2">
                      {project.title}
                    </CardTitle>
                      ...
                      <div className="flex items-center">
                        <div
                          className={`w-3 h-3 sm:w-4 sm:h-4 rounded-full mr-2 sm:mr-3 ${
                            project.submission_count > 0 ? "bg-green-600" : "bg-amber-600"
                          }`}
                        ></div>
                  ...
                  <CardFooter className="flex flex-col gap-2 sm:gap-3 pt-0 p-5 sm:p-6 lg:p-8">
                    <Button
                      ...
                      variant="outline"
                      className="w-full border-2 border-gray-300 text-gray-700 font-semibold px-4 py-3 sm:px-6 sm:py-4 rounded-xl shadow-sm hover:bg-gray-50 hover:shadow-md transition-all duration-200 text-sm sm:text-base"
                    >
                    ...
                    <Button
                      asChild
                      className="w-full bg-blue-500 text-white font-semibold px-4 py-3 sm:px-6 sm:py-4 rounded-xl shadow-md hover:bg-blue-600 hover:shadow-lg transition-all duration-200 text-sm sm:text-base"
                    >

...
export function FileUploader({ id, file, onFileChange, accept, isDark = false }: FileUploaderProps) {
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center gap-2 text-center cursor-pointer">
            ...
            <div className="space-y-1">
              ...
              <p className={`text-xs ${themeClasses.mutedText}`}>JPG, PNG, GIF (最大10MB)</p>
            </div>
          </div>
